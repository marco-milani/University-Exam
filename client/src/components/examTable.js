...
function StudyPlanForm() {
    ...
    return (
        <>
            ...
            <Form style={{ textAlign: "center" }} onSubmit={handleSubmit} hidden={!hidden}>
            <Form.Label>Select type of study plan</Form.Label>
                ...
                <br/>
                <Button variant="success" type="submit" style={{ fontSize: fontSize }}>Save</Button>
          &nbsp;
            <Button variant="danger" style={{ fontSize: fontSize }} onClick={() => setHidden(!hidden)}>Cancel</Button>
            </Form>
        </>
    )
